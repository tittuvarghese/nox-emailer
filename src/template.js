...
/**
* generateEmailContent - Function to generate email template
* @param configuration
* @param data
*/

let generateEmailContent = (configuration, data) => {
  return new Promise(function(resolve,reject) {
    if(!configuration || !data) {
      reject("Unable to proceed with configuration and data.")
    } else {
      let template = `<html>
      <head>
      <link href="https://fonts.googleapis.com/css?family=Open+Sans" rel="stylesheet">
      <link href="https://fonts.googleapis.com/css?family=Lato:400,300,700,900" rel="stylesheet" type="text/css">
      <title>`+ configuration.general.templateName +`</title><!-- Responsive Styles and Valid Styles -->
      <style type="text/css">
      body{
        width: 100%;
        background-color: `+ configuration.styles.backgroundColor +`;
        margin:0;
        padding:0;
      ...
      <body>
      <!-- ======= main section ======= -->
      <table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="`+ configuration.styles.backgroundColor +`" class="editablr">
      ...
      <table border="0" align="center" width="460" cellpadding="0" cellspacing="0" bgcolor="`+ configuration.styles.primaryBackgroundColor +`" class="container590 sasa-w" style="border-top-left-radius: 5px; border-top-right-radius: 5px; background-position: bottom center; background-repeat: no-repeat;">
      ...
      <!-- ======= logo ======= -->
      <td align="center">
      <a href="" style="display: block; border-style: none !important; border: 0 !important;" class="edit_img"><img editable="true" mc:edit="logo" width="60" border="0" style="display: block;" src="`+ configuration.general.companyIcon +`" alt=""></a>
      </td>
      </tr>
      </tbody></table>
      </td>
      ...
      <tr>
      <td align="center" mc:edit="main-header2" style="color: `+ configuration.styles.lightTextColor +`; font-size: 28px; font-family: Open Sans, sans-serif;; mso-line-height-rule: exactly; line-height: 26px;" class="title_color main-header">
      <!-- ======= section header ======= -->
      ...
      <tbody><tr>
      <td align="center" mc:edit="main-text2" style="color: `+ configuration.styles.lightTextColor +`; font-size: 14px; font-family: Lato, sans-serif; mso-line-height-rule: exactly; line-height: 22px;" class="text_color">
      ...
      <tr>
      <td align="center">
      <a href="`+ data.buttonLink +`" style="color: `+ configuration.styles.lightTextColor +`; text-decoration: none;">
      ...
      <tr>
      <td align="center" style="color: `+ configuration.styles.lightTextColor +`; font-size: 12px; font-family: Open Sans, sans-serif;; font-weight: 700;" mc:edit="main-button">
      <!-- ======= main section button ======= -->
      <div style="line-height: 25px;">
      <singleline>`+ data.buttonText +`</singleline>
      </div>
      </td>
      </tr>
      ...
      <div class="koso" style="margin:0 auto;"> <tr class="tata2">
      <td align="center" class="sasa">
      <table border="0" align="center" width="460" cellpadding="0" cellspacing="0" bgcolor="`+ configuration.styles.secondaryBackgroundColor +`" class="container590 sasa-w" style="border-bottom-right-radius: 5px; border-bottom-left-radius: 5px;">
      <tbody><tr><td height="35" style="font-size: 35px; line-height: 35px;">&nbsp;</td></tr>
      <tr>
      <td align="center">
      <table border="0" width="320" align="center" cellpadding="0" cellspacing="0" class="container580">
      <tbody><tr>
      <td align="center" mc:edit="footer-text" style="color: `+ configuration.styles.darkTextColor +`; font-size: 15px; font-family: Lato, sans-serif; mso-line-height-rule: exactly; line-height: 25px;" class="text_color">
      ...
      If you have any queries, then please reply to this email or contact us at <span style="color: `+ configuration.styles.primaryTextColor +`;">`+ configuration.general.supportEmail +`</span>
      </multiline>
      </div>
      </td>
      </tr>
      ...
      <tr class="tata">
      <td align="center">
      <img src="`+ configuration.general.companyLogo +`" alt="`+ configuration.general.companyName +`" title="`+ configuration.general.companyName +`" width="100"/>
      </td>
      </tr>
      <tr class="tata"><td height="20" style="font-size: 20px; line-height: 20px;">&nbsp;</td></tr>
      <tr class="tata">
      ...
      <td align="center" mc:edit="footer-text2" style="text-align:center; color: `+ configuration.styles.footerTextColor +`; font-size: 11px; font-family: Lato, sans-serif; mso-line-height-rule: exactly; line-height: 25px;" class="sasa">
      <div style="line-height: 20px" class="edit_text sasa-w">
      <!-- ======= section text ======= -->
      <multiline spellcheck="false" style="display: inline-block; pointer-events: visible;">
      Copyright &copy; `+ configuration.general.companyName +`. All rights reserved. To ensure delivery to your inbox, add `+ configuration.general.supportEmail +` to your address book.<br />
      You are receiving this email because you have registered with `+ configuration.general.companyName +` and part of our growing audience network.
      </multiline>
      </div>
      </td>
      </tr></div>
